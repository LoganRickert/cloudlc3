...
MAIN    ; int main() {
        ...
        ;; --------\\ Stack \\-------- ;;
        ;; | ----                  | ;; #0 | R6 - Stack Pointer | R5 - Frame Pointer
        ;; | Frame Pointer (R5)    | ;;
        ;; | Return Address (R7)   | ;;
        ;; | Return Value          | ;; #3
        ;; | -- Bottom of Stack -- | ;;
...
_MAIN
        AND R0 R0 #0    ; int space = 4
        ADD R0 R0 #4    ; int space = 4
        JSR PUSH    ; Push space

        JSR ALLOC   ; Call alloc
        JSR POP     ; Get return value
B_1        ADD R6 R6 #1    ; Remove variable pushed

        AND R0 R0 #0    ; int space = 4
        ADD R0 R0 #10    ; int space = 4
        ADD R0 R0 #10    ; int space = 4
        JSR PUSH    ; Push space

        JSR ALLOC   ; Call alloc
        JSR POP     ; Get return value
B_2        ADD R6 R6 #1    ; Remove variable pushed
        ...
        JSR ALLOC   ; Call alloc
        JSR POP     ; Get return value
B_3        ADD R6 R6 #1    ; Remove variable pushed
        ...
        JSR ALLOC   ; Call alloc
        JSR POP     ; Get return value
B_4        ADD R6 R6 #1    ; Remove variable pushed
